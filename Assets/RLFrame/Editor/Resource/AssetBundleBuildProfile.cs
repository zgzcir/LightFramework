...
public class AssetBundleBuildProfileInspector : Editor
{
    public List<string> prefabsPath = new List<string>();
    [FormerlySerializedAs("AssetDirectory")] public List<AssetBundleBuildProfile.AssetDirectoryConfig> AssetDirectories = new List<AssetBundleBuildProfile.AssetDirectoryConfig>();
    [FormerlySerializedAs("AssetBundleLoadConfigDirectory")] public AssetBundleBuildProfile.AssetDirectoryConfig AssetBundleLoadProfileDirectory;
}